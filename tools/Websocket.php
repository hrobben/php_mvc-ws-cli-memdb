...
class echoServer extends WebSocketServer {
    ...
    protected function process ($user, $message) {
        switch($message){
            ...
            case "help"   : $this->send($user, "help: <br> articles  => to show all articles.<br>XML => to make output shown in XML on/off.<br>JSON => output in JSON on/off.<br>article=1 => gives single article id=1");
                break;
            ...
            case "JSON"   :
                ...
                break;
            case "cli"   : $this->send($user, (ISCLI?"<b>Your on command line!</b>":"Not on command line!")); break;
            default      : $this->send($user, "not understood, type help for help");    break;
        }
    }
